...
class CustomerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'rentalcompany.map.CustomerTableMap';
    ...
    {
        $this->addRelation('Rentalaction', 'Rentalaction', RelationMap::ONE_TO_MANY, array('id' => 'customer_id', ), null, null, 'Rentalactions');
    } // buildRelations()
