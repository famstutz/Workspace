 ...
 *
 * @method CustomerQuery leftJoinRentalaction($relationAlias = null) Adds a LEFT JOIN clause to the query using the Rentalaction relation
 * @method CustomerQuery rightJoinRentalaction($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Rentalaction relation
 * @method CustomerQuery innerJoinRentalaction($relationAlias = null) Adds a INNER JOIN clause to the query using the Rentalaction relation
 *
...
abstract class BaseCustomerQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'rentalcompany', $modelName = 'Customer', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `ID`, `NAME` FROM `customer` WHERE `ID` = :p0';
        try {
    ...
    public function filterByRentalaction($rentalaction, $comparison = null)
    {
        if ($rentalaction instanceof Rentalaction) {
            return $this
                ->addUsingAlias(CustomerPeer::ID, $rentalaction->getCustomerId(), $comparison);
